...
class Moderateur
{
     ...
     * Add idProjAp
     *
     * @param \Insarise\MessagingBundle\Entity\Projet $idProjAp
     * @return Moderateur
     */
    public function addIdProjAp(\Insarise\MessagingBundle\Entity\Projet $idProjAp)
    {
     ...
     * @param \Insarise\MessagingBundle\Entity\Projet $idProjAp
     */
    public function removeIdProjAp(\Insarise\MessagingBundle\Entity\Projet $idProjAp)
    {
