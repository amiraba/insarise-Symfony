...
class Competence
{
     ...
     * Add idCandEc
     *
     * @param \Insarise\MessagingBundle\Entity\Candidat $idCandEc
     * @return Competence
     */
    public function addIdCandEc(\Insarise\MessagingBundle\Entity\Candidat $idCandEc)
    {
     ...
     * @param \Insarise\MessagingBundle\Entity\Candidat $idCandEc
     */
    public function removeIdCandEc(\Insarise\MessagingBundle\Entity\Candidat $idCandEc)
    {
     ...
     * Add idProjPc
     *
     * @param \Insarise\MessagingBundle\Entity\Projet $idProjPc
     * @return Competence
     */
    public function addIdProjPc(\Insarise\MessagingBundle\Entity\Projet $idProjPc)
    {
     ...
     * @param \Insarise\MessagingBundle\Entity\Projet $idProjPc
     */
    public function removeIdProjPc(\Insarise\MessagingBundle\Entity\Projet $idProjPc)
    {
