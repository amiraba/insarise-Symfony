...
class Etape
{
     ...
     * Set idEntEt
     *
     * @param \Insarise\MessagingBundle\Entity\Entreprise $idEntEt
     * @return Etape
     */
    public function setIdEntEt(\Insarise\MessagingBundle\Entity\Entreprise $idEntEt = null)
    {
     ...
     * Set idCandEt
     *
     * @param \Insarise\MessagingBundle\Entity\Candidat $idCandEt
     * @return Etape
     */
    public function setIdCandEt(\Insarise\MessagingBundle\Entity\Candidat $idCandEt = null)
    {
     ...
     * Get idCandEt
     *
     * @return \Insarise\MessagingBundle\Entity\Candidat 
     */
     ...
     * Set idProjEt
     *
     * @param \Insarise\MessagingBundle\Entity\Projet $idProjEt
     * @return Etape
     */
    public function setIdProjEt(\Insarise\MessagingBundle\Entity\Projet $idProjEt = null)
    {
     ...
     * Get idProjEt
     *
     * @return \Insarise\MessagingBundle\Entity\Projet 
     */
