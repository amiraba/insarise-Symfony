...
class Projet
{
     ...
     * Set idEntProj
     *
     * @param \Insarise\InsariseBundle\Entity\Entreprise $idEntProj
     * @return Projet
     */
    public function setIdEntProj(\Insarise\InsariseBundle\Entity\Entreprise $idEntProj = null)
    {
     ...
     * Add idModAp
     *
     * @param \Insarise\InsariseBundle\Entity\Moderateur $idModAp
     * @return Projet
     */
    public function addIdModAp(\Insarise\InsariseBundle\Entity\Moderateur $idModAp)
    {
     ...
     * @param \Insarise\InsariseBundle\Entity\Moderateur $idModAp
     */
    public function removeIdModAp(\Insarise\InsariseBundle\Entity\Moderateur $idModAp)
    {
     ...
     * Add idComPc
     *
     * @param \Insarise\InsariseBundle\Entity\Competence $idComPc
     * @return Projet
     */
    public function addIdComPc(\Insarise\InsariseBundle\Entity\Competence $idComPc)
    {
     ...
     * @param \Insarise\InsariseBundle\Entity\Competence $idComPc
     */
    public function removeIdComPc(\Insarise\InsariseBundle\Entity\Competence $idComPc)
    {
