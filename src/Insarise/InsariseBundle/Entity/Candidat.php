...
class Candidat
{
     ...
     * Add idComEc
     *
     * @param \Insarise\InsariseBundle\Entity\Competence $idComEc
     * @return Candidat
     */
    public function addIdComEc(\Insarise\InsariseBundle\Entity\Competence $idComEc)
    {
     ...
     * @param \Insarise\InsariseBundle\Entity\Competence $idComEc
     */
    public function removeIdComEc(\Insarise\InsariseBundle\Entity\Competence $idComEc)
    {
